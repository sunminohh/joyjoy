...
<script type="text/javascript" src="/resources/js/bookReply.js"></script> 
...
$(document).ready(function() {
	...
	$(".uploadResult").on("click", "li", function(e){
		...
		if (liObj.data("type")){
			...
			//download
			self.location = "/bookDownload?fileName=" +path
		}
	});
	...
	function showImage(fileCallPath){
		...
		$(".bigPicture")
			.html("<img src='/bookDisplay?fileName=" +fileCallPath+"'>")
			.show();
	}
...
$("button[data-oper='list']").on("click", function(e) {
		...
		let action = link.includes("user/mypost") ? "/user/mypost" : link.includes("user/myreply") ? "/user/myreply" : "/book/list";
