        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    <a href="/admin/board" class="nav-item nav-link"><i class="fa fa-user me-2"></i>Board</a>
                    <a href="/admin/reply" class="nav-item nav-link"><i class="fa fa-star me-2"></i>Reply</a>
                </div>
            </nav>
        </div>
        <!-- Sidebar End -->
