		...
		<div class="row g-4">
			...
			<div class="col-12">
				<div class="bg-secondary rounded h-100 p-4">
					...
					<form id="operForm" action="/game/modify" method="get">
...
<script type="text/javascript" src="/resources/js/gameReply.js"></script> 
...
$(document).ready(function() {
	...
	$.getJSON("/game/getAttachList", {bno: bno}, function(arr){
	...
	$(".uploadResult").on("click", "li", function(e){
		...
		if (liObj.data("type")){
			...
			//download
			self.location = "/gameDownload?fileName=" +path
		}
	});
	...
	function showImage(fileCallPath){
		...
		$(".bigPicture")
			.html("<img src='/gameDisplay?fileName=" +fileCallPath+"'>")
			.show();
	}
...
$(document).ready(function() {
	...
	$("button[data-oper='modify']").on("click", function(e) {
		operForm.attr("action", "/game/modify").submit();
	});
	
$("button[data-oper='list']").on("click", function(e) {
		
		let link = document.referrer;
		let action = link.includes("user/mypost") ? "/user/mypost" : link.includes("user/myreply") ? "/user/myreply" : "/game/list";
