		...
		<div class="row g-4">
			...
			<div class="col-12">
				<div class="bg-secondary rounded h-100 p-4">
					...
					<form id="operForm" action="/etc/modify" method="get">
...
<script type="text/javascript" src="/resources/js/etcNav.js"></script> 
<script type="text/javascript" src="/resources/js/etcReply.js"></script> 
...
$(document).ready(function() {
	...
	$.getJSON("/etc/getAttachList", {bno: bno}, function(arr){
		...
		$(arr).each(function(i, attach){
			...
			if(attach.fileType){
				...
				str += "<img src='/etcDisplay?fileName=" +fileCallPath+"'>";
				str += "</div>";
				str += "</li>";
	...
	$(".uploadResult").on("click", "li", function(e){
		...
		if (liObj.data("type")){
			...
			//download
			self.location = "/etcDownload?fileName=" +path
		}
	});
	...
	function showImage(fileCallPath){
		...
		$(".bigPicture")
			.html("<img src='/etcDisplay?fileName=" +fileCallPath+"'>")
			.show();
	}
...
$(document).ready(function() {
	...
	$("button[data-oper='modify']").on("click", function(e) {
		operForm.attr("action", "/etc/modify").submit();
	});
