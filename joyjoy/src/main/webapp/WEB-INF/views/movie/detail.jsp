...
$(document).ready(function() {
	...
	$("button[data-oper='list']").on("click", function(e) {
        ...
        //let action = link.includes("user/mypost") ? "/user/mypost" : "/movie/list";
        let action = link.includes("user/mypost") ? "/user/mypost" : link.includes("user/myreply") ? "/user/myreply" : "/movie/list";
