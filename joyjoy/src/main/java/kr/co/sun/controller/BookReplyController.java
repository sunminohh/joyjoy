...
import kr.co.sun.service.BookReplyService;
import lombok.AllArgsConstructor;
import lombok.extern.log4j.Log4j;

@RequestMapping("/bookReplies/")
@RestController
@Log4j
@AllArgsConstructor
public class BookReplyController {
	...
	public ResponseEntity<String> create(@RequestBody BookReplyVO vo) {
	...
	public ResponseEntity<String> remove(@RequestBody BookReplyVO vo,
	...
	@RequestMapping(method = { RequestMethod.PUT, RequestMethod.PATCH },
			...
			consumes = "application/json",
			produces = {MediaType.TEXT_PLAIN_VALUE})
	public ResponseEntity<String> modify(@RequestBody BookReplyVO vo,
											@PathVariable("rno") Long rno) {
