...
import kr.co.sun.service.GameReplyService;
import kr.co.sun.service.MovieReplyService;
import lombok.AllArgsConstructor;
import lombok.extern.log4j.Log4j;

@RequestMapping("/gameReplies/")
@RestController
@Log4j
@AllArgsConstructor
public class GameReplyController {
	
	private GameReplyService service;
	
	@PreAuthorize("isAuthenticated()")
	@PostMapping(value = "/new", 
			consumes = "application/json",
			produces = {MediaType.TEXT_PLAIN_VALUE})
	public ResponseEntity<String> create(@RequestBody GameReplyVO vo) {
	...
	public ResponseEntity<String> remove(@RequestBody GameReplyVO vo,
	...
	@RequestMapping(method = { RequestMethod.PUT, RequestMethod.PATCH },
			...
			consumes = "application/json",
			produces = {MediaType.TEXT_PLAIN_VALUE})
	public ResponseEntity<String> modify(@RequestBody GameReplyVO vo,
											@PathVariable("rno") Long rno) {
