...
public class MovieUploadController {
	...
	@PostMapping(value = "/movieUploadAjaxAction", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
	@ResponseBody
	public ResponseEntity<List<MovieAttachDTO>> uploadAjaxPost(MultipartFile[] uploadFile) {
		
		List<MovieAttachDTO> list = new ArrayList<>();
		String uploadFolder = "C:\\upload\\movie";
	...
	public ResponseEntity<byte[]> getFile(String fileName) {
		...
		File file = new File("c:\\upload\\movie\\" + fileName);
	...
	@GetMapping(value = "/movieDownload", produces = MediaType.APPLICATION_OCTET_STREAM_VALUE)
	@ResponseBody
	public ResponseEntity<Resource> downloadFile(@RequestHeader("User-Agent") String userAgent, String fileName) {
		
		Resource resource = new FileSystemResource("C:\\upload\\movie\\" + fileName);
	...
	public ResponseEntity<String> deleteFile(String fileName, String type){
		...
		try {
			file = new File("c:\\upload\\movie\\" + URLDecoder.decode(fileName, "UTF-8"));
