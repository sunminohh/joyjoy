...
public class GameBoardController {
	...
	public String register(GameBoardVO board, RedirectAttributes rttr) {
	...
	@PostMapping("/modify")
	public String moddify(GameBoardVO board, 
		...
		return "redirect:/game/list" + page.getListLink();
	}
	...
	public String remove(@RequestParam("bno") Long bno,
		...
		List<GameAttachVO> attachList = service.getAttachList(bno);
	...
	@ResponseBody
	public ResponseEntity<List<GameAttachVO>> getAttachList(Long bno){
	...
	private void deleteFiles(List<GameAttachVO> attachList) {
		...
		attachList.forEach(attach -> {
			try {
				Path file = Paths.get("C:\\upload\\game\\" 
			...
			+ "_" + attach.getFileName());
				...
				if (Files.probeContentType(file).startsWith("image")) {
					...
					Path thumbNail = Paths.get("C:\\upload\\game\\" 
