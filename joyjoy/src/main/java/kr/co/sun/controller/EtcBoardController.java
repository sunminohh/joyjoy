...
import kr.co.sun.service.EtcBoardService;
...
public class EtcBoardController {
	...
	private EtcBoardService service;
	...
	public String register(EtcBoardVO board, RedirectAttributes rttr) {
	...
	@PostMapping("/modify")
	public String moddify(EtcBoardVO board, 
		...
		return "redirect:/etc/list" + page.getListLink();
	}
	...
	public String remove(@RequestParam("bno") Long bno,
		...
		List<EtcAttachVO> attachList = service.getAttachList(bno);
	...
	@ResponseBody
	public ResponseEntity<List<EtcAttachVO>> getAttachList(Long bno){
	...
	private void deleteFiles(List<EtcAttachVO> attachList) {
		...
		attachList.forEach(attach -> {
			try {
				Path file = Paths.get("C:\\upload\\etc\\" 
			...
			+ "_" + attach.getFileName());
				...
				if (Files.probeContentType(file).startsWith("image")) {
					...
					Path thumbNail = Paths.get("C:\\upload\\etc\\" 
