...
import kr.co.sun.mapper.BookAttachMapper;
...
public class BookBoardService {
	...
	@Transactional
	public void register(BookBoardVO board) {
	...
	public BookBoardVO get(Long bno) {
	...
	public boolean updateRead(Long bno) {
		...
		BookBoardVO board = mapper.read(bno);
	...
	public List<BookBoardVO> getList(Pagination page) {
