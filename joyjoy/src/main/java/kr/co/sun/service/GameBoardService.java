...
public class GameBoardService {
	...
	@Setter(onMethod = @__({@Autowired}))
	private GameAttachMapper attachMapper;

	@Transactional
	public void register(GameBoardVO board) {
	...
	public GameBoardVO get(Long bno) {
	...
	public boolean updateRead(Long bno) {
		...
		GameBoardVO board = mapper.read(bno);
	...
	@Transactional
	public boolean modify(GameBoardVO board) {
	...
	public List<GameBoardVO> getList(Pagination page) {
	...
	public List<GameAttachVO> getAttachList(Long bno) {
